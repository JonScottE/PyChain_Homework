...
###########   lol I though about this for toooo loooooong.....   input_data = st.text_input("Block Data")

# @TODO: DONE
# Add an input area where you can get a value for `sender` from the user.
deets_from_sender = st.text_input("Sender, tweet me your deets!")

# @TODO: DONE
# Add an input area where you can get a value for `receiver` from the user.
deets_from_receiver = st.text_input("Receiver, tweet me your deets!")

# @TODO: DONE
# Add an input area where you can get a value for `amount` from the user.
all_the_deets = st.text_input("How many tendies we talking???")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        Record(deets_from_sender, deets_from_receiver, all_the_deets),
        creator_id=42,
